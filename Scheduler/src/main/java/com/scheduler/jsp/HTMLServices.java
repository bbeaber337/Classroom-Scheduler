...
//--------------------------------------------------------------------------------------------
	...
	public void buildEditClassroom(int classroomID) throws Exception {
		...
		out.append("</br><div class=\"col-xs-3\"><label for=\"roomBoardType\">Board Type</label></br><select name=\"roomBoardType\"><option selected value='" + item.getRoomBoardType() + "'>" + item.getRoomBoardType() + "</option><option value='Whiteboard'>Whiteboard</option><option value='Smartboard'>Smartboard</option><option value='Any'>Any</option></select></div></br></br></br>");
